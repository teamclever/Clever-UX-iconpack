...
public final class RequestLimiter {
  ...
  public static RequestLimiter get(Context context) {
    return new RequestLimiter(
        context.getResources().getInteger(com.clever.ux.R.integer.icon_request_limit_interval),
  ...
  public static boolean needed(@Nullable Context context) {
    return context != null
        && context.getResources().getInteger(com.clever.ux.R.integer.icon_request_limit_interval) > 0;
  }
}
