...
import com.clever.ux.adapters.IconMoreAdapter;
import com.clever.ux.config.Config;
import com.clever.ux.fragments.IconsFragment;
import com.clever.ux.transitions.CircularRevealTransition;
import com.clever.ux.ui.base.BaseThemedActivity;
import com.clever.ux.ui.base.ISelectionMode;
...
public class IconMoreActivity extends BaseThemedActivity
  ...
  @BindView(com.clever.ux.R.id.toolbar)
  Toolbar mToolbar;
  ...
  public int getLastStatusBarInsetHeight() {
    ...
    return findViewById(com.clever.ux.R.id.root).getPaddingTop();
  }

  @Override
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(com.clever.ux.R.layout.activity_icons_more);
    ...
    if (mToolbar.getNavigationIcon() != null) {
      mToolbar.setNavigationIcon(
          TintUtils.createTintedDrawable(
              mToolbar.getNavigationIcon(), DialogUtils.resolveColor(this, com.clever.ux.R.attr.tab_icon_color)));
    }
  ...
  private void setUpTransitions() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      ...
      circularRevealTransition.addTarget(getString(com.clever.ux.R.string.transition_name_circular_reveal));
      ...
      enterSlide.excludeTarget(getString(com.clever.ux.R.string.transition_name_circular_reveal), true);
      ...
      returnSide.excludeTarget(getString(com.clever.ux.R.string.transition_name_circular_reveal), true);
