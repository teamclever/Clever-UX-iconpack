  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    final MaterialDialog.Builder builder =
        new MaterialDialog.Builder(getActivity())
            .title(icon.getName())
            .negativeText(com.clever.ux.R.string.dismiss);
    final MaterialDialog dialog;

    if (getArguments().containsKey("icon")) {
      dialog = builder.customView(com.clever.ux.R.layout.dialog_icon_view, false).build();
      assert dialog.getCustomView() != null;

      ImageView iconView = (ImageView) dialog.getCustomView().findViewById(com.clever.ux.R.id.icon);
            ...
            .generate(
                new Palette.PaletteAsyncListener() {
                  ...
                  public void onGenerated(Palette palette) {
                    ...
                    if (color == 0) {
                      color = DialogUtils.resolveColor(getActivity(), com.clever.ux.R.attr.colorAccent);
                    }
      ...
      dialog =
          builder
              .content(
                  Html.fromHtml(getString(com.clever.ux.R.string.invalid_drawable_error, icon.getDrawable())))
